...
public class HotelServiceTest {
	...
	void setUp() throws Exception {
		...
		hotelService = new HotelService(hotelRepository, userRepository,
				...
				new UserService(userRepository, new UserToUserDTO(new HotelToHotelDTO(new RoomToRoomDTO(new OrderToOrderDTO(roomRepository, userRepository), hotelRepository)), new OrderToOrderDTO(roomRepository, userRepository)), new UserDTOToUser(new HotelToHotelDTO(new RoomToRoomDTO(
