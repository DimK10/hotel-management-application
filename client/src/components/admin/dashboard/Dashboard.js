...
import {getStatisticsAction} from "../../../actions/hotel";
...
const Dashboard = props => {
    ...
    const {statistics, loading: statisticsLoading} = useSelector(state => state.hotel);
                                    ...
                                    <div className="row mb-5 m-auto">
                                        <div className="col-6 d-flex align-content-center justify-content-center">
                                            <div className="c-chart-wrapper">
                                                <MainChart statistics={statistics} loading={statisticsLoading}/>
                                            </div>
                                        </div>
                                        <div
                                            className="col-6 text-center d-flex flex-column justify-content-center">

                                            <h5>Rooms: {statistics.all}</h5>
                                            <h5>Available: {Number(statistics.all) - Number(statistics.vacant)}</h5>
                                            <h5>Vacant: {statistics.vacant}</h5>
